...
public class HelloServiceLocator extends org.apache.axis.client.Service implements it.ex.impl.HelloService {
    ...
    public it.ex.impl.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.ex.impl.HelloSoapBindingStub _stub = new it.ex.impl.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.ex.impl.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                it.ex.impl.HelloSoapBindingStub _stub = new it.ex.impl.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://impl.ex.it", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://impl.ex.it", "Hello"));
        }
